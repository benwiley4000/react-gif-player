...
<html>
  <head>
    ...
    <!-- gifplayer.css v0.3.1 -->
    <link rel="stylesheet" href="https://unpkg.com/react-gif-player@0.3.1/dist/gifplayer.css">
  </head>
  <body>
    <div id="cat"></div>
    ...
    <!-- gifplayer.js v0.3.1 -->
    <script src="https://unpkg.com/react-gif-player@0.3.1/dist/gifplayer.js"></script>
    <script>
      ReactDOM.render(
