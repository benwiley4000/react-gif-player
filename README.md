...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://unpkg.com/react-gif-player@0.4.0/dist/gifplayer.css">
  </head>
  <body>
    <div id="cat"></div>
    ...
    <!-- gifplayer.js v0.4.0 -->
    <script src="https://unpkg.com/react-gif-player@0.4.0/dist/gifplayer.js"></script>
    <script>
      ReactDOM.render(
